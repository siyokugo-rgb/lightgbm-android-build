...
object NarV2TransformParityTest {

    private const val FIXTURE_ASSET =
        "nar-v2/android-transform-parity-fixture.json"
    ...
    fun run(context: Context): String {
        ...
        require(
            ...
            "model feature count != 64"
        }

        val modelFile =
            File(
                context.filesDir,
                "nar_v2_transform_test_model.txt"
            )
        ...
        for (i in 0 until entries.length()) {
            ...
            require(actual.size == 64) {
                "$entryId: actual feature count != 64"
            }

            require(expected.length() == 64) {
                "$entryId: expected feature count != 64"
            }
